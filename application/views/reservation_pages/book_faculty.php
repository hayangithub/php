                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <form id="formadd" accept-charset="utf-8" method="post">
                                    ...
                                    <div class="row">            
                                        <div class="box-footer">
                                            <div class="pull-right">                                         
                                                <button type="button" onclick="addReservationModalClose();" data-loading-text="Cancel" class="btn btn-danger pull-right" autocomplete="off" >Cancel</button>
                                                <button type="button" onclick="add_reservation();" data-loading-text="Save" class="btn btn-primary-green-color pull-right" atocomplete="off" >Save</button>
                                            </div>
                                        </div>
                                    </div><!--./row-->  
                                </form>                       
