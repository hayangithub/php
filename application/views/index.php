...
<html>
    <head>
        ...
        <link href="../build/css/site-style.css" rel="stylesheet">
        <style>
    ...
    <body>
        <div class="login-form">
            ...
            <h1> <img src="../images/logo.jpg" alt="..." height="70px" width="70px" class="img-circle profile_img"></h1>
            <div class="form-group ">
                <input type="text" class="form-control" placeholder="Username" value="hayan.ibr@cas.edu.om" id="UserName" autocomplete="off">
        ...
        <script src="../build/js/site-js.js"></script>
